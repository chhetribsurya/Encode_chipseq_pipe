...
export RUN_PATH=`pwd`
export TF_FILE_PATH="/gpfs/gpfs1/home/schhetri/k562_chip/PE_libraries_info"
#export TF_FILE_PATH="/gpfs/gpfs1/home/schhetri/for_encode/spp_idr_peak_call_scripts/pseudo_double_rep"
#export LIB_PATH="/gpfs/gpfs1/home/schhetri/for_encode/spp/Libraries"
export LIB_PATH="/gpfs/gpfs1/home/schhetri/k562_chip/k562_PE_fastq_libraries"
export BASE_DIR="/gpfs/gpfs1/home/schhetri/k562_chip/k562_PE_chip_analysis_final"
...
export BSUB_OPTIONS="-We 24:00 -q c7normal -n 4 -R span[hosts=1]" # Using new cluster
#export BSUB_OPTIONS="-We 24:00 -q c7normal -R rusage[mem=40000]" # Using new cluster
#export JOB_PREFIX="head_K562_PE"
export JOB_PREFIX="K562_PE"
