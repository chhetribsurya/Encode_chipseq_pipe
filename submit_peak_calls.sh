...
for i in "${!LIB_REP1[@]}"; do
	...
	FRAGLEN_REP1=$(cut -f 3 $BASE_DIR/Analysis/$REP1/$REP1.filt.nodup.sample.15.MATE1.tagAlign.gz.cc.qc | tr "\n" "\t"| cut -f 1)
	#FRAGLEN_REP1=$(cut -f 3 $BASE_DIR/Analysis/$REP1/$REP1.filt.nodup.sample.15.SE.tagAlign.gz.cc.qc)
	FRAGLEN_REP2=$(cut -f 3 $BASE_DIR/Analysis/$REP2/$REP2.filt.nodup.sample.15.MATE1.tagAlign.gz.cc.qc | tr "\n" "\t"| cut -f 1)
    ...
    #.filt.nodup.srt.PE2SE.tagAlign.gz # True Rep1 and Control
    #.filt.nodup.PE2SE.pr1.tagAlign.gz # Rep1 pseudo-replicate
	# True Rep 1 vs control
	bsub $BSUB_OPTIONS -o "$MY_OUTPUT_DIR/${REP1}_true_rep1.out" -J "${REP1}_${REP2}_${CONTROL1}_${CONTROL2} Peak calling" ./PeakCallers.main.sh $BASE_DIR/Analysis/$REP1/$REP1.filt.nodup.srt.PE2SE.tagAlign.gz $BASE_DIR/Analysis/$CONTROL1/$CONTROL1.filt.nodup.srt.PE2SE.tagAlign.gz $MY_OUTPUT_DIR $FRAGLEN_REP1

	# True Rep 2 vs control
	bsub $BSUB_OPTIONS -o "$MY_OUTPUT_DIR/${REP2}_true_rep2.out" -J "${REP1}_${REP2}_${CONTROL1}_${CONTROL2} Peak calling" ./PeakCallers.main.sh $BASE_DIR/Analysis/$REP2/$REP2.filt.nodup.srt.PE2SE.tagAlign.gz $BASE_DIR/Analysis/$CONTROL2/$CONTROL2.filt.nodup.srt.PE2SE.tagAlign.gz $MY_OUTPUT_DIR $FRAGLEN_REP2

	# Rep 1 Self PR 1 vs control
	bsub $BSUB_OPTIONS -o "$MY_OUTPUT_DIR/${REP1}_pr1.out" -J "${REP1}_${REP2}_${CONTROL1}_${CONTROL2} Peak calling" ./PeakCallers.main.sh $BASE_DIR/Analysis/$REP1/$REP1.filt.nodup.PE2SE.pr1.tagAlign.gz $BASE_DIR/Analysis/$CONTROL1/$CONTROL1.filt.nodup.srt.PE2SE.tagAlign.gz $MY_OUTPUT_DIR $FRAGLEN_REP1

	# Rep 1 Self PR 2 vs control
 	bsub $BSUB_OPTIONS -o "$MY_OUTPUT_DIR/${REP1}_pr2.out" -J "${REP1}_${REP2}_${CONTROL1}_${CONTROL2} Peak calling" ./PeakCallers.main.sh $BASE_DIR/Analysis/$REP1/$REP1.filt.nodup.PE2SE.pr2.tagAlign.gz $BASE_DIR/Analysis/$CONTROL1/$CONTROL1.filt.nodup.srt.PE2SE.tagAlign.gz $MY_OUTPUT_DIR $FRAGLEN_REP1

	# Rep 2 Self PR 1 vs control
	bsub $BSUB_OPTIONS -o "$MY_OUTPUT_DIR/${REP2}_pr1.out" -J "${REP1}_${REP2}_${CONTROL1}_${CONTROL2} Peak calling" ./PeakCallers.main.sh $BASE_DIR/Analysis/$REP2/$REP2.filt.nodup.PE2SE.pr1.tagAlign.gz $BASE_DIR/Analysis/$CONTROL2/$CONTROL2.filt.nodup.srt.PE2SE.tagAlign.gz $MY_OUTPUT_DIR $FRAGLEN_REP2

	# Rep 2 Self PR 2 vs control
	bsub $BSUB_OPTIONS -o "$MY_OUTPUT_DIR/${REP2}_pr2.out" -J "${REP1}_${REP2}_${CONTROL1}_${CONTROL2} Peak calling" ./PeakCallers.main.sh $BASE_DIR/Analysis/$REP2/$REP2.filt.nodup.PE2SE.pr2.tagAlign.gz $BASE_DIR/Analysis/$CONTROL2/$CONTROL2.filt.nodup.srt.PE2SE.tagAlign.gz $MY_OUTPUT_DIR $FRAGLEN_REP2
