...
# Get inputs together #
REP1_TA_FILE=$REP1_DIR/$REP1.filt.nodup.srt.PE2SE.tagAlign.gz
REP2_TA_FILE=$REP2_DIR/$REP2.filt.nodup.srt.PE2SE.tagAlign.gz

CONTROL1_TA_FILE=$CONTROL1_DIR/$CONTROL1.filt.nodup.srt.PE2SE.tagAlign.gz
CONTROL2_TA_FILE=$CONTROL2_DIR/$CONTROL2.filt.nodup.srt.PE2SE.tagAlign.gz

REP1_PR1_TA_FILE=$REP1_DIR/$REP1.filt.nodup.PE2SE.pr1.tagAlign.gz
REP1_PR2_TA_FILE=$REP1_DIR/$REP1.filt.nodup.PE2SE.pr2.tagAlign.gz

REP2_PR1_TA_FILE=$REP2_DIR/$REP2.filt.nodup.PE2SE.pr1.tagAlign.gz
REP2_PR2_TA_FILE=$REP2_DIR/$REP2.filt.nodup.PE2SE.pr2.tagAlign.gz
